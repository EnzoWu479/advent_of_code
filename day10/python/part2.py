...
for y, line in enumerate(trail):
    for x, cell in enumerate(line):
        if cell == 0:
            found = search_sequence(Location(x, y, trail), 1)
            total += found
print(total)   
